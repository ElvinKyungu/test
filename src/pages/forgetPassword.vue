<script lang="ts" setup>
  ...
  const isFormValid = computed(() => {
    return email.value === '' && errors.value.invalidEmail === ''
  })
        ...
        <div class="py-12 bg-indigo-100 lg:bg-white flex flex-col justify-center lg:justify-start lg:px-12">
          ...
          <div class="mt-8">
            <div class="text-xl text-[#222] text-center tracking-wide ml-2">
              To reset your password, please enter your e-mail address and we will send you an e-mail
              ...
              <div>
                <div class="flex gap-4 w-full relative mt-8">
                  <div class="relative w-full">
                    <div class="text-lg font-bold text-gray-700 tracking-wide ml-4 mb-2">
                      Your mail adress
                    </div>
                    <div
                ...
                <div class="mt-10 flex gap-10">
                  <button
                    ...
                    class="bg-[#388087] text-gray-100 p-4 w-full rounded-full tracking-wide font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-[#295f64] shadow-lg"
