...
const email = ref('')
// const { sendResetPasswordEmail, error, loading } = useAuth()
const handleSubmit = () => {
...
<template>
  <h1 
    ...
    We will send you a reset link by e-mail. 
  </h1>
    ...
    <form @submit.prevent="handleSubmit">
      <div
        ...
        >
          ...
          <div class="leading-3 relative w-1/2">
            <div class="relative">
              <input
                type="text" 
                class="
        ...
        <button
          type="submit"
          class="bg-[#6cd2e7] flex relative text-white p-2 mt-5 rounded"
        >
          Send reset link
        </button>
        <!-- <span v-if="error" class="text-gray-500 text-sm mt-2">
          {{ error ? error : '' }}
        </span> -->
    </form>
  </div>
